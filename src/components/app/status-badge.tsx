  ...
  return (
    <Badge
      ...
      className={cn(
        ...
        (normalized.includes("CONCLUIDO") || normalized.includes("ENTREGUE")) && "border-emerald-200 bg-emerald-50 text-emerald-800",
        (normalized.includes("DIVERGENCIA") || normalized.includes("CANCELADO")) && "border-red-200 bg-red-50 text-red-800",
      )}
    >
