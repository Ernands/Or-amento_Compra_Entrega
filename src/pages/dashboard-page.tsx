...
export function DashboardPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="Visão executiva" title="Dashboard de implantação" description="Acompanhe a preparação das 27 lojas, do levantamento inicial à conferência da entrega." actions={<RefreshButton />} />
